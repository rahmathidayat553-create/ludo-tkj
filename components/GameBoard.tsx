        ...
        <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen bg-gray-900 p-4 gap-8">
            <div className="w-full lg:w-auto flex flex-col items-center">
                <div className="flex justify-between w-full max-w-2xl mb-4">
                     <h1 className="text-3xl font-bold text-cyan-400">Ludo Game</h1>
                     <button
                        onClick={logout}
            ...
            <div className="w-full lg:w-80 bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-700">
                <h2 className="text-2xl font-bold text-center mb-4 border-b border-gray-600 pb-2">Game Info</h2>
                ...
                {winner ? (
                    <div className="text-center p-4 rounded-lg bg-yellow-500/20 border border-yellow-500">
                        <div className="flex justify-center items-center gap-2">
                           ...
                           <p className={`text-xl font-bold ${colorClasses[winner]?.text}`}>{players[winner].name} Wins!</p>
                        </div>
                    </div>
                ) : (
                ...
                <div className="mt-6 space-y-3">
                    <h3 className="text-lg font-semibold text-center text-gray-400">Player Scores</h3>
